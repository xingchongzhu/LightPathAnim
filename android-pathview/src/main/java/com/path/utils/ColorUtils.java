...
import static com.path.utils.Tools.getDisplayMetrics;
...
public class ColorUtils {
    ...
    public static Drawable getRandomDrawable(Context context) {
        ...
        drawable.setCornerRadius(Tools.dpiFromPx(10,getDisplayMetrics(context)));
    ...
    public static Drawable getRandomDrawable(Context context, float radiusDp) {
        ...
        drawable.setCornerRadius(Tools.dpiFromPx((int) radiusDp,getDisplayMetrics(context)));
        drawable.setColors(new int[]{
                getRandomColor(),
                getRandomColor(),
                getRandomColor(),
