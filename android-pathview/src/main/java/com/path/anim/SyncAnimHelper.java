...
public class SyncAnimHelper extends BaseAnimHelper {

    public SyncAnimHelper() {
        super();
    }

    public SyncAnimHelper(View view, Path sourcePath, Path animPath) {
        super(view, sourcePath, animPath);
    }

    public SyncAnimHelper(View view, Path sourcePath, Path animPath, long animTime, boolean isInfinite) {
